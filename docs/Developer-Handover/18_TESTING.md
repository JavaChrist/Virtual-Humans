...
Voice/TTS 11C (`140_`/`141_`) : wiring + binding/consent fakes (`phase-11c-voice-tts-production-wiring.test.ts`, `phase-11c-narrator-binding-and-consent.test.ts`) ; **0** ElevenLabs / Storage / flags. VoiceId jamais dans les assertions.
