...
Voice/TTS 11C (`140_`–`152_`) : wiring + catalogue + grants + seed + binding + live preflight (`phase-11c-voice-tts-live-preflight.test.ts`) ; migrations-static **32/32** ; **0** ElevenLabs / flags. VoiceId jamais dans les assertions. DB locale N/A le 16 août.
