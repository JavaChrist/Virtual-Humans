...
| Motion Transfer | Registry MT-002 + Router **MT-003 IMPLEMENTED** (`routeMotionTransfer`, `maximumFallbacksPerStep=0`, **0** candidat Production → `motion_capability_unavailable`) ; Engine MT-004 NOT STARTED ; `RUNTIME_NOT_IMPLEMENTED_YET` ; interdits fallback I2V/T2V silencieux |
