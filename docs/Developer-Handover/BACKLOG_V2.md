...
- **Prochaine porte majeure** : Auth **`AUTH_VHS_POST_LIPSYNC_WIRING_HUMAN_NEXT_PRIORITY_DECISION_NO_DEPLOY_NO_FLAG_WRITE`** — décision humaine · 0 provider · 0 flag. RideCloud apply **suspendu**. Living handover : `CURRENT_STATE_AND_RESUME.md`.
