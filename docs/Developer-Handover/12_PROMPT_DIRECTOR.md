...
| Suite | overlay déterministe WIRED_DISABLED ; compose Production (`118_`) ; composed HUMAN_REJECTED (`119_`) ; glyphes fix local (`120_`) non déployé ; parent réutilisable ; pas de 3ᵉ génération |
