...
| Suite | overlay déterministe WIRED_DISABLED ; compose Production (`118_`) ; composed HUMAN_REJECTED (`119_`) ; preflight 1.1.0 (`121_`) PASS ; parent réutilisable ; pas de 3ᵉ génération |
