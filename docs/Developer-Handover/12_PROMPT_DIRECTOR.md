...
| Suite | overlay déterministe WIRED_DISABLED ; set no-text persisté (`115_`) ; decode PNG 0–4 (`116_`) ; compose mémoire PASS (`117_`) ; 0 composed écrit ; pas de 3ᵉ génération |
