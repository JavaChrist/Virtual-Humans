...
| Suite | overlay déterministe WIRED_DISABLED ; compose 1.0.0 HUMAN_REJECTED (`119_`) ; composé 1.1.0 `4429654f…` HUMAN_REJECTED layout (`123_`) ; composeur 1.2.0 enfant `49284892…` HUMAN_APPROVED inactif (`127_`) ; 11A CLOSED (`128_`) ; I2V WIRED_DISABLED (`129_`) ; parent conservé ; pas de 3ᵉ génération |
