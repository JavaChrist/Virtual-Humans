...
| Alignement | remote **31** / local **32** |
| Dernière migration remote | `20260815195207_vhs_11c_voice_identity_catalog` |
| Local-only | `20260815212100_vhs_11c_voice_identity_catalog_grant_hardening` · **non appliquée** |
...
| Grants actuels | `service_role=arwdDxtm` via DEFAULT PRIVILEGES · PUBLIC/anon/authenticated = 0 |
| Grants cibles | identities/bindings SELECT+INSERT+UPDATE · consent SELECT+INSERT · DELETE/TRUNCATE/REFERENCES/TRIGGER révoqués |
