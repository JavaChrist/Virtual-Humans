...
|---|---|---|---|
| Unitaires | **2065/2065** | suite + harnais adversatif `188_`/`189_` | 2026-08-28 `189_` |
...
| DB integration | **35/35** | Supabase local `virtual-humans-studio-local` | 2026-08-28 `189_` |
| pgTAP | 378 | **historique** | 11 août / 10A |
| Intégration DB historique | 33/33 | **historique** | 11 août / 10A |
| E2E Playwright `/director` | persistence-only 3113 **5/5** · `PERSISTENCE_DURABLE_E2E_SKIPPED=0` | `189_` local | 2026-08-28 |
| Fraîcheur living handover | PASS | tooling | `184_` |

Ne pas présenter pgTAP 378 comme relancé aujourd’hui. L’intégration 35/35 et Playwright 5/5 **sont** relancés (`189_`).
