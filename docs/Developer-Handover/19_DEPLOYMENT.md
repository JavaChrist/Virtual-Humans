...
| Motion Transfer | flags `MOTION_TRANSFER_*` OFF (`67_`…`70_`) — worker/review refuse tant que OFF ; QC/review fake hors harness ; privacy blocked ; migration MT-005 **NOT APPLIED** Production ; **ne pas** activer sur Vercel |
