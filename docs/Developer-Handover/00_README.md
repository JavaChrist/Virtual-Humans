...
P1 fermé                 : grant apply preflight (`146_`) · grant hardening local (`145_`) · apply catalog vide (`144_`)
Prochaine porte majeure  : AUTH_11C_VOICE_IDENTITY_CATALOG_GRANT_HARDENING_REMOTE_APPLY_ONCE
