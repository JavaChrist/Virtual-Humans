...
Runtime AI / paid media  : OFF · applicatif **245bea2** · composeur 1.2.0 local seulement
...
P1 ouverts               : preflight parent réel 1.2.0 (mémoire · 0 nouvel asset)
P1 fermé                 : typo/layout 1.2.0 local · HR 1.1.0 REJECT · execution · preflight · glyphes
Prochaine porte majeure  : AUTH_11A_PROFESSIONAL_OVERLAY_REAL_PARENT_PREFLIGHT_NO_PROVIDER
