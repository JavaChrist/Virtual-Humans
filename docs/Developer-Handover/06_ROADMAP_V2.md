...
| MT-001…004 | Domain → Registry → Router → Engine dry-run | **IMPLEMENTED** (`60_`…`63_`) · Gates MT-1…MT-3 **PASS** · next = **MT-005** |
| MT-005… | Storage → provider → benchmark | **NOT STARTED** · Production MT candidates = 0 |
