...
| MT-001…003 | Domain → Registry → Router | **IMPLEMENTED** (`60_`/`61_`/`62_`) · Gate MT-1/MT-2 **PASS** · next = **MT-004** Engine |
| MT-004… | Engine → … → benchmark | **NOT STARTED** · Production MT candidates = 0 |
