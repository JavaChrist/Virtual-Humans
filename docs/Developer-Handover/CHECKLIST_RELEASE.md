...
- [ ] quotas/providers confirmés **(distant)** — Marketing (10B), Creative (10C), Script (10D) et Art texte (10E-V3) validés ; Storyboard/média restent à autoriser ;
...
- [ ] smoke tests providers bornés — Marketing / Creative / Script / Art texte : **PASS** ; suite Storyboard/média : à faire ;
