...
- [x] Preflight remote Voice catalog (`143_`) · **VOICE_IDENTITY_CATALOG_REMOTE_MIGRATION_PREFLIGHT_READY_FOR_APPLY_AUTH** · 0 write · 0 apply ;
...
- [x] RideCloud storyboard VO harden (`161_`) · **RIDECLOUD_FIRST_AD_STORYBOARD_AUDIO_CONTINUITY_HARDENED** · CTA scindé ;
...
- [x] App update blockers sync+deploy (`177_`) · **VHS_APP_UPDATE_BLOCKERS_WORKFLOW_INTEGRATION_SYNC_AND_DEPLOY_ONCE_READY** · SHA `7d1c34c` · docs sync **terminée** (`9b62799`) · 0 flag ;
- [x] Lipsync `/director` wiring disabled (`178_`) · **VHS_DIRECTOR_LIPSYNC_PATH_WIRED_DISABLED_READY** · SHA `366abd6` · 0 provider · 0 flag ;
...
- [x] Director persistence hardening sync+deploy (`190_`) · **VHS_DIRECTOR_PERSISTENCE_PRODUCTION_ENABLEMENT_HARDENING_SYNC_AND_DEPLOY_READY** · SHA servi `1cadcb0` · 1 push · 0 flag write ;
...
Director UI-only : **ENABLED / RUNTIME OFF** (`185_`) · persistence OFF · SHA servi `1cadcb0`
Director persistence : **HARDENED DEPLOY READY** (`190_`) · SHA servi `1cadcb0` · tree `a785949` · flag OFF · 0 flag write
