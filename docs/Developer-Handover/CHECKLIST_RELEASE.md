...
- [ ] quotas/providers confirmés **(distant)** — Marketing (10B), Creative (10C), Script (10D) et Art texte (10E-V3) validés ; Storyboard continuity diag **READY_FOR_RETRY_PREP** (`48_…`, prompt v3) ; budget 113/101/12 ; média restent à autoriser ;
...
- [ ] smoke tests providers bornés — Marketing / Creative / Script / Art texte : **PASS** ; Storyboard : DIAG OK → RETRY-PREP v3 ; budget 113/101/12 ; média : à faire ;
