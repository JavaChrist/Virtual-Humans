...
- [ ] quotas/providers confirmés **(distant)** — Marketing (10B), Creative (10C), Script (10D) et Art texte (10E-V3) validés ; Storyboard diag **READY_FOR_RETRY_PREP** (fix oneOf local) ; Auth A budget **PASS** (113¢ / 20¢) ; média restent à autoriser ;
...
- [ ] smoke tests providers bornés — Marketing / Creative / Script / Art texte : **PASS** ; Storyboard : diag OK, reauth requise ; budget Auth A **PASS** ; média : à faire ;
