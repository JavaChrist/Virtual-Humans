...
- [x] Live preflight I2V no provider (`130_`) · **I2V_LIVE_PREFLIGHT_NO_PROVIDER_READY_FOR_PAID_AUTH** · shortfall 143¢ · 0 fal ;
...
I2V `/director` : **WIRED_DISABLED** · live preflight READY (`130_`) · `57de914` · 0 fal
