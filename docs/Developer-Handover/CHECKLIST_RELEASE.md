...
- [ ] quotas/providers confirmés **(distant)** — Marketing (10B), Creative (10C), Script (10D) et Art texte (10E-V3) validés ; Storyboard Auth B resume **BLOCKED** (`request_failed`) ; Auth A budget **PASS** (113¢ / 20¢) ; média restent à autoriser ;
...
- [ ] smoke tests providers bornés — Marketing / Creative / Script / Art texte : **PASS** ; Storyboard : **BLOCKED** (`request_failed`, auth consommée) ; budget Auth A **PASS** ; média : à faire ;
