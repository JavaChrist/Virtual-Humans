...
- [ ] quotas/providers confirmés **(distant)** — Marketing (10B), Creative (10C), Script (10D) et Art texte (10E-V3) validés ; Storyboard RETRY2-PREP **READY_FOR_PUSH_AND_REAUTH** (`45_…`) ; Auth A budget **PASS** (113¢ / 20¢) ; média restent à autoriser ;
...
- [ ] smoke tests providers bornés — Marketing / Creative / Script / Art texte : **PASS** ; Storyboard : RETRY2-PREP prêt (push/deploy/salt/reauth) ; budget Auth A **PASS** ; média : à faire ;
