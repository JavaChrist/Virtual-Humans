...
- [ ] quotas/providers confirmés **(distant)** — Marketing (10B), Creative (10C), Script (10D) et Art texte (10E-V3) validés ; Storyboard V3 deploy-preflight **READY_FOR_PROVIDER_REAUTH** (`51_…`, dry-run live OK) ; execute provider encore requis ; média restent à autoriser ;
...
- [ ] smoke tests providers bornés — Marketing / Creative / Script / Art texte : **PASS** ; Storyboard : deploy-preflight OK → Auth provider v3 ; budget 115/101/14 ; média : à faire ;
