...
**vhs-overlay-latin-bitmap-shapes-v1** — atlas 8×8 local (ASCII + FR + U+2019) remplaçant le hash LCG du composeur 1.0.0 ; lookup fail-closed ; composeur **1.1.0** preflight mémoire PASS (`120_`/`121_`).
