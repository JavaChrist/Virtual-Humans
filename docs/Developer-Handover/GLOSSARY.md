...
**ACCEPT_PREFLIGHT_VISUAL** — jugement visuel humain du preflight 1.2.0 autorisant l’écriture d’un enfant privé ; **≠** `APPROVE` dans `human_review_decisions` (`125_`/`126_`).
