...
Audience adaptation must preserve Mei’s identity.
...
The Scene Builder defines Mei’s state at the beginning of every scene.
...
The Image Workflow generates static visual assets while preserving Mei’s approved identity.
...
The product and Mei are validated independently.
...
Lip-sync generation must not change Mei’s facial identity.
...
Identity Validation confirms that Mei remains visually and behaviorally recognizable.
...
Provider artifacts must not redefine Mei’s hairstyle.

---

# 98. Age Validation

Mei must remain within the approved perceived age range.
...
```text
mei_video_commercial_scene-001_v1_2026-07-20.mp4
```
...
This document is the official production workflow specification of the Mei Character SDK.
