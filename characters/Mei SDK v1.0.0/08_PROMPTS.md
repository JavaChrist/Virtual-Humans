...
This document defines the official Prompt Engine used to generate every visual, audio and video asset involving Mei.
...
The Prompt Engine never invents Mei.
...
The prompt must never redefine Mei manually.
...
Mei guides the audience.

She never overshadows the product.
...
Secondary characters never redefine Mei.
...
Vehicle identity is independent of Mei.
...
Provider adapters translate the canonical Prompt DSL into the syntax expected by each AI model without modifying Mei's identity.
