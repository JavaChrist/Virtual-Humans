# FICHIER : `characters/Mei SDK v1.0.0/videos/README.md`
...
Ce dossier contient les règles d’exploitation vidéo propres à Mei.
...
Toute génération vidéo de Mei doit respecter les documents suivants :
...
Une instruction ponctuelle ne peut jamais modifier l’identité permanente de Mei.
...
Le mode officiel pour les vidéos avec Mei est :
...
Le text-to-video seul n’est pas le mode recommandé pour les plans principaux de Mei.
...
Mei parle directement à la caméra.
...
Mei présente un téléphone, une application ou un objet.
...
Mei réalise une action sans parler directement.
...
```text
MEI-VIDEO-YYYYMMDD-XXX
```

Exemple :

```text
MEI-VIDEO-20260720-001
```
...
```yaml
production_id: MEI-VIDEO-20260720-001
character: mei
platform: instagram
...
Mei looks directly into the camera with a warm, confident and natural expression.
She speaks calmly and makes one small open-hand gesture to emphasize her point.
...
Preserve her facial identity, hairstyle, body proportions, outfit and accessories.
...
Une génération est rejetée immédiatement si elle contient :
...
Le dossier vidéo suit le versionnement du SDK de Mei.

Une modification nécessite une mise à jour de version lorsqu’elle change :
...
# FICHIER : `characters/Mei SDK v1.0.0/videos/shared.md`

```md
# SHARED VIDEO RULES — MEI
...
Ce fichier contient les règles communes à toutes les générations vidéo de Mei.
...
Mei doit être reconnaissable immédiatement dans chaque vidéo.
...
Toute vidéo principale doit partir d’une image officielle ou validée de Mei.
...
Les mouvements de Mei doivent être :
...
Par défaut, Mei regarde l’objectif.
...
```text
Mei briefly looks at the phone screen, then naturally returns her gaze to the camera.
```
...
```text
The camera gently tracks her movement at eye level.
```
...
```text
At the beginning, Mei looks directly into the camera.
She gives a small natural smile.
She raises one open hand to emphasize her point.
She then lowers her hand and maintains eye contact until the end.
```
...
* être stable ;
* ne pas distraire ;
* laisser Mei clairement identifiable.
...
1. générer Mei tenant le téléphone ;
...
Ne pas accepter une voix différente simplement parce qu’elle a été générée avec la vidéo.
...
```text
Mei maintains a stable facial identity and a relaxed professional posture.
Her gestures are subtle and natural.
...
Mei looks directly into the camera with a warm, confident and approachable expression.
She speaks naturally with subtle breathing and realistic blinking.
She makes one small open-hand gesture to emphasize her message.
Her posture remains relaxed and professional.
The camera stays stable with a very slow push-in.
Soft natural lighting and consistent background.

Preserve her exact facial identity, hairstyle, hair color, skin tone,
...
She looks briefly at the screen, then returns her gaze to the camera.
She gives a small confident smile and presents the phone with a subtle hand gesture.
Her fingers remain naturally positioned around the device.
The camera remains stable.
Soft natural lighting.

Preserve her exact identity, hairstyle, body proportions, outfit and accessories.
...
Mei stands in a modern professional environment.
She calmly interacts with the object in front of her,
then briefly looks toward the camera with a natural smile.
Subtle realistic movement.
Stable camera and soft lighting.

Preserve her exact identity, outfit and physical appearance.
```
...
Une seed ne garantit pas à elle seule une reproduction parfaite lorsque le modèle ou la plateforme évolue.
...
Chaque plan doit rester suffisamment simple pour que l’identité de Mei demeure stable.
...
# FICHIER : `characters/Mei SDK v1.0.0/videos/runway.md`
...
# FICHIER : `characters/Mei SDK v1.0.0/videos/veo.md`
...
# FICHIER : `characters/Mei SDK v1.0.0/videos/kling.md`
...
# FICHIER : `characters/Mei SDK v1.0.0/videos/minimax.md`

```md
# MINIMAX VIDEO GUIDE — MEI
...
Ce fichier adapte le Video SDK de Mei aux capacités vidéo de MiniMax.
...
1. référence de sujet officielle lorsqu’elle est disponible ;
2. image-to-video ;
...
She gives a small friendly smile and makes one subtle open-hand gesture.
Natural blinking, subtle breathing and realistic facial movement.
Her posture remains relaxed and professional.
The camera remains stable at eye level.
Preserve her exact identity, hairstyle, proportions,
outfit and accessories throughout the shot.
````
...
```text
Use the provided subject reference as the permanent identity of Mei.

Create a medium close-up at eye level.
Mei looks directly into the camera,
speaks naturally and makes one small open-hand gesture.
Her facial identity, hairstyle, skin tone,
...
Mei naturally transitions between the two poses.
Her identity, hairstyle, face, body proportions,
outfit, accessories, lighting and background remain unchanged.
The camera remains stable.
No sudden movement.
```
...
```text
[CAMERA_COMMAND]
Mei maintains direct eye contact and makes a subtle hand gesture.
```
...
She presents the phone with a subtle controlled movement.
Her hands, fingers and the phone remain stable.
Soft natural lighting.
Preserve her exact identity and outfit.
```
...
Ce mode est adapté aux plans de coupe sans Mei.
...
* réduire la durée ;
* éviter le text-to-video pour Mei.
...
Les modes de référence doivent être privilégiés chaque fois que l’identité de Mei est visible.
...
# FICHIER : `characters/Mei SDK v1.0.0/videos/openai.md`
...
# FICHIER : `characters/Mei SDK v1.0.0/videos/future-models.md`
