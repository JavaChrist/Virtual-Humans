...
This document defines the official capabilities of Mei.
...
This specification applies to Mei’s capabilities across:
...
A capability describes what Mei is able and authorized to perform.
...
No provider may grant Mei an undeclared capability.
...
Mei’s capabilities are organized into:
...
```text
“Create a 20-second Instagram video where Mei presents a mobile application.”
...
Mei can preserve her approved identity across supported production formats.
...
Mei can appear as a credible professional presenter.
...
Mei can deliver factual or informational content without excessive emotion or persuasion.
...
Mei can deliver approved scripts through synchronized voice, facial motion and body behavior.
...
Mei can address the camera directly while maintaining natural gaze and professional behavior.
...
Mei can speak from an approved script.
...
Mei can deliver natural dialogue using approved conversational behavior.
...
Mei can narrate a structured story with controlled emotional variation.
...
Mei can explain concepts clearly using structured verbal and visual communication.
...
Mei can guide an audience through ordered actions.
...
Mei can ask scripted or dynamically generated questions using appropriate conversational behavior.
...
Mei can provide approved answers in supported interactive environments.
...
Mei can introduce a guest, ask approved questions and react using controlled listening behavior.
...
Mei can respond to an interviewer using approved knowledge and conversational workflows.
...
Mei can represent an approved brand according to `06_BRAND.md`.
...
Mei can visually introduce and present an approved product.
...
Mei can demonstrate supported product functions through physically plausible actions.
...
Mei can compare approved products using factual, brand-safe criteria.
...
Mei can explain an approved feature and its intended benefit.
...
Mei can perform persuasive commercial presentations while preserving credibility.
...
Mei can deliver an approved call to action.
...
Mei can deliver a structured sales pitch.
...
Mei may respond to predefined objections using approved commercial knowledge.
...
Mei can guide a user through an approved onboarding sequence.
...
Mei can present a software application, website or digital service.
...
Mei can demonstrate a mobile application through:
...
Mei can explain a desktop or web interface using:
...
Mei can guide users through an approved website experience.
...
Mei can indicate interface elements visually.
...
Mei can narrate an approved screen recording.
...
Mei can deliver educational tutorials using clear pacing and structured demonstrations.
...
Mei can present structured learning modules.
...
Mei can present approved language-learning content.
...
Mei can demonstrate approved words and phrases using controlled voice output.
...
Mei can present listening and repetition exercises.
...
Mei can ask approved quiz questions and present answers.
...
Mei can deliver structured non-clinical coaching content.

She must not represent herself as a licensed medical, psychological, legal or financial professional.
...
Mei can present help content and approved troubleshooting steps.
...
Mei can present approved questions and answers.
...
Mei can guide users through validated troubleshooting steps.
...
Mei can appear in validated static images.
...
Mei can appear in close-up and portrait compositions.
...
Mei can appear in full-body compositions.
...
Mei can be exported with a transparent background when supported by the production workflow.
...
Mei can be generated against a uniform chroma background.
...
Mei can appear in controlled studio environments.
...
Mei can appear in physically plausible outdoor environments.
...
Mei can appear in branded advertising visuals.
...
Mei can appear in platform-adapted social media visuals.
...
Mei can appear in high-readability thumbnail compositions.
...
Mei can appear in horizontal or platform-specific banner layouts.
...
Mei can appear in AI-generated video using approved video workflows.
...
Mei can deliver speech in a stable talking-head composition.
...
Mei can perform controlled full-body actions in supported video providers.
...
Mei can appear in structured commercial productions.
...
Mei can deliver visual tutorials using narration, demonstrations and interface integration.
...
Mei can appear in short-form social productions.
...
Mei can be produced in vertical formats such as `9:16`.
...
Mei can be produced in horizontal formats such as `16:9`.
...
Mei can be produced in square formats such as `1:1`.
...
Mei can appear across several continuity-managed scenes.
...
Mei’s approved voice may be used without visible on-screen speech.
...
Mei can speak through synchronized mouth animation.
...
Mei can appear as a pre-rendered avatar generated from approved scripts.
...
Mei can participate in controlled interactive sessions when connected to:
...
Mei can operate as a real-time avatar when latency and provider requirements are satisfied.
...
Mei can participate in real-time conversation through an external conversational intelligence system.
...
Mei can maintain behavioral and conversational continuity during one active session.
...
Mei can visually signal attention while another participant speaks.
...
Mei can alternate between listening and speaking states.
...
Mei can produce restrained visual reactions based on detected conversational events.
...
Mei can hold an approved smartphone using physically plausible hand placement.
...
Mei can perform controlled touch and viewing actions.
...
Mei can hold and interact with a tablet.
...
Mei can perform basic laptop presentation actions.
...
Mei can hold approved products when their geometry and scale are known.
...
Mei can visually direct attention toward a product.
...
Mei can pick up supported objects using physically plausible motion.
...
Mei can place supported objects on a defined surface.
...
Mei can present approved cars, motorcycles or other supported vehicles.
...
Mei can perform basic vehicle interactions such as:
...
Mei can visually present an approved motorcycle.
...
Mei can walk over short, defined distances in compatible video workflows.
...
Mei can present while standing.
...
Mei can present from an approved seated position.
...
Mei can appear in professional office environments.
...
Mei can appear in approved retail or showroom environments.
...
Mei can appear in controlled visual studios.
...
Mei can appear in natural or urban outdoor scenes.
...
Mei can appear in staged event, exhibition or presentation environments.
...
Mei can appear with one or more approved characters.
...
Mei can participate in scripted dialogue scenes.
...
Mei can host or accompany another approved character.
...
Mei can speak supported languages when an approved voice configuration exists.
...
Mei can present localized versions of approved content.
...
Mei can present externally validated translations.
...
Mei’s productions may include synchronized subtitles.
...
Mei can use slower, clearer delivery for accessibility-oriented productions.
...
Mei can be produced across multiple controlled variants.
...
Mei can participate in coordinated multi-asset campaigns.
...
Mei’s content can be adapted for several approved platforms.
...
Mei can be produced in controlled A/B variants.
...
Mei’s generated assets can be evaluated through the SDK validation pipeline.
...
The system can prepare Mei’s assets for publication.
...
A capability available to Mei is not automatically available to Tom or another character.
...
Mei must not be represented as possessing undeclared or unauthorized expertise.
...
* real human employee when she is not
* real customer when she is not
* independent witness
...
Mei must not claim real personal experiences.

She may use scripted illustrative language only when clearly framed as fictional or demonstrative.

---

# 182. Expertise Claims

Mei may explain approved information.

She must not claim professional certification unless explicitly declared and legally validated.

---

# 183. Human Identity Disclosure

Productions must not intentionally misrepresent Mei as a real natural person where disclosure is required.
...
Mei’s default production-ready capability set includes:
...
Mei’s beta capabilities include:
...
Mei’s experimental capabilities include:
...
This document is the official capability specification for Mei.

It defines the complete set of actions, production modes and interaction types Mei is authorized and technically expected to perform.
