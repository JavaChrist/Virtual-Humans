...
-- Remote version  : 20260804140225
-- Remote name     : vhs_125_remainder_part3
-- Applied (UTC)   : 2026-08-04T14:02:25Z (version timestamp from MCP apply)
-- Payload SHA-256 : 8c6610b44cefc280e4f310d63603592bdf2afc12a1f9f2a44c332e31de72ea78
-- Objects covered : begin_or_get_export_director_run, persist_export_package,
--                   REVOKE/GRANT EXECUTE for VHS-125 delivery RPCs
...
DO $vhs_125_remainder_part3_marker$
BEGIN
  NULL;
END
$vhs_125_remainder_part3_marker$;
