import { ArtAnalysisCandidateSchema, type ArtAnalysisCandidate } from "@/domain/art";
import type { OpenAIResponseResult } from "../contracts";
import { OpenAIAiError } from "../errors";

/** Parses transport output only; ArtDirector owns validation and finalization. */
export function parseArtCandidateResponse(result: OpenAIResponseResult): ArtAnalysisCandidate {
  ...
  const candidate = ArtAnalysisCandidateSchema.safeParse(parsed);
