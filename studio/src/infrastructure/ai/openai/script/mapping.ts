...
export type MapScriptRequestResult = {
...
export function mapScriptAnalysisRequest(input: {
  brief: VideoProjectBrief;
  marketingPlan: MarketingPlan;
  creativeConcept: CreativeConcept;
  locale?: string;
}): MapScriptRequestResult {
  const b = input.brief;
  ...
  return { briefPayload, marketingPayload, creativePayload, userMessage, findings, blockingFindings };
}

export function approximateScriptTokenCount(text: string): number {
